 ...
 */
final class Version20251228190155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE application (id INT AUTO_INCREMENT NOT NULL, status VARCHAR(50) NOT NULL, applied_at DATETIME NOT NULL, cv_filename VARCHAR(255) DEFAULT NULL, motivation LONGTEXT DEFAULT NULL, test_score DOUBLE PRECISION DEFAULT NULL, phone VARCHAR(20) DEFAULT NULL, city VARCHAR(100) DEFAULT NULL, candidate_id INT NOT NULL, offer_id INT NOT NULL, assigned_test_id INT DEFAULT NULL, INDEX IDX_A45BDDC191BD8781 (candidate_id), INDEX IDX_A45BDDC153C674EE (offer_id), INDEX IDX_A45BDDC114C5BCD6 (assigned_test_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, content LONGTEXT NOT NULL, is_read TINYINT NOT NULL, sent_at DATETIME NOT NULL, sender_id INT NOT NULL, receiver_id INT NOT NULL, offer_id INT DEFAULT NULL, INDEX IDX_B6BD307FF624B39D (sender_id), INDEX IDX_B6BD307FCD53EDB6 (receiver_id), INDEX IDX_B6BD307F53C674EE (offer_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE saved_offer (id INT AUTO_INCREMENT NOT NULL, saved_at DATETIME NOT NULL, candidate_id INT NOT NULL, offer_id INT NOT NULL, INDEX IDX_44055C2791BD8781 (candidate_id), INDEX IDX_44055C2753C674EE (offer_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE test (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, duration INT NOT NULL, min_score INT NOT NULL, recruiter_id INT NOT NULL, job_offer_id INT NOT NULL, INDEX IDX_D87F7E0C156BE243 (recruiter_id), INDEX IDX_D87F7E0C3481D195 (job_offer_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE application ADD CONSTRAINT FK_A45BDDC114C5BCD6 FOREIGN KEY (assigned_test_id) REFERENCES test (id)');
        ...
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307F53C674EE FOREIGN KEY (offer_id) REFERENCES job_offer (id)');
        ...
        $this->addSql('ALTER TABLE saved_offer ADD CONSTRAINT FK_44055C2791BD8781 FOREIGN KEY (candidate_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE saved_offer ADD CONSTRAINT FK_44055C2753C674EE FOREIGN KEY (offer_id) REFERENCES job_offer (id)');
        $this->addSql('ALTER TABLE test ADD CONSTRAINT FK_D87F7E0C156BE243 FOREIGN KEY (recruiter_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE test ADD CONSTRAINT FK_D87F7E0C3481D195 FOREIGN KEY (job_offer_id) REFERENCES job_offer (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE application DROP FOREIGN KEY FK_A45BDDC114C5BCD6');
        ...
        $this->addSql('ALTER TABLE saved_offer DROP FOREIGN KEY FK_44055C2791BD8781');
        $this->addSql('ALTER TABLE saved_offer DROP FOREIGN KEY FK_44055C2753C674EE');
        $this->addSql('ALTER TABLE test DROP FOREIGN KEY FK_D87F7E0C156BE243');
        $this->addSql('ALTER TABLE test DROP FOREIGN KEY FK_D87F7E0C3481D195');
